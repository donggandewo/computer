...
<!-- xiangqing -->
    ...
    <div class="jieshao mt20 w">
        ...
        <div class="right fr">
            <div class="h3 ml20 mt20">${requestScope.productName}</div>
            <div class="jianjie mr40 ml20 mt10">${requestScope.description}<%--变焦双摄，4 轴防抖 / 骁龙835 旗舰处理器，6GB 大内存，最大可选128GB 闪存 / 5.15" 护眼屏 / 四曲面玻璃/陶瓷机身--%>
            </div>
            <div class="jiage ml20 mt10">${requestScope.product.newPrice}元</div>
            ...
            <div class="xqxq mt20 ml20">
                <div class="top1 mt10">
                    <div class="left1 fl">${requestScope.product.description}</div>
                    <div class="right1 fr"><%--2499.00元--%>${requestScope.product.newPrice}元</div>
                    <div class="clear"></div>
                </div>
